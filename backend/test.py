...
tokenizer_1 = AutoTokenizer.from_pretrained("google/flan-t5-base")
model_1 = AutoModelForSeq2SeqLM.from_pretrained("google/flan-t5-base").to('cpu')

# Initialize the tokenizer and model for Model 2 (FLAN-T5)
tokenizer_2 = AutoTokenizer.from_pretrained("google/flan-t5-base")
model_2 = AutoModelForSeq2SeqLM.from_pretrained("google/flan-t5-base").to('cpu')
