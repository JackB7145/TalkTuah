  ...
  return (
    <div className="w-full min-h-screen bg-yellow-100 flex flex-col justify-center items-center">
      ...
      <div className='w-[80%] min-h-[38rem] flex justify-center items-center font-medium text-amber-200 text-3xl'>
        <p>This Application showcases the abilities for AI to discuss any topic, please enter a topic in the form of a statement such as "cats are better than dogs" rather than "cats versus dogs"</p>
      </div>
